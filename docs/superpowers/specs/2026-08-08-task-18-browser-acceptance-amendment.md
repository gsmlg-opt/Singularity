...
OS process argument, environment variable, log, telemetry field, or audit
metadata.
...
JSON, logs, audit metadata, telemetry, and the browser console.
...
metadata, telemetry, and the browser console.
