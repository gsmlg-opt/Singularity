defmodule Singularity.Runtime.DTO.NoteHistoryPage do
  @moduledoc "One bounded page of immutable private note version summaries."
  ...
  @type t :: %__MODULE__{items: [NoteVersionSummary.t()], next_cursor: String.t() | nil}
  ...
  defp validate_items(items) do
    Enum.reduce_while(items, {:ok, []}, fn
      %NoteVersionSummary{} = item, {:ok, checked} ->
        case NoteVersionSummary.new(Map.from_struct(item)) do
