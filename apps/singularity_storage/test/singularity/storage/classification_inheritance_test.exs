defmodule Singularity.Storage.ClassificationInheritanceTest do
  ...
  @schemas [
    ...
    {Singularity.Storage.Schema.Content.NoteVersion, "content", "note_versions"},
    {Singularity.Storage.Schema.Content.NoteConflict, "content", "note_conflicts"},
    {Singularity.Storage.Schema.Content.NoteSearchDocument, "content", "note_search_documents"},
    {Singularity.Storage.Schema.Content.NoteMutationReceipt, "content", "note_mutation_receipts"},
